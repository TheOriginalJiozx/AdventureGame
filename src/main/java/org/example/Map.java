...
public class Map {
    ...
    private Room createWorld() {
        ...
        room4.addItems(new MeleeWeapon("Danmarks Våben", 70, 4500));
        ...
        room6.addItems(new RangedWeapon("The Devils Flamethrower", 50, 20, 7000));
        ...
        room8.addItems(new MeleeWeapon("Tarzan's Spear", 70, 3500));
        ...
        room9.addItems(new MeleeWeapon("King Kong's Fist", 60, 5500));
        room9.addItems(new MeleeWeapon("Harley Quinn's Bat", 70, 2500));
        room9.addItems(new RangedWeapon("Harley Quinn's Joke Gun", 200, 15, 4000));
        ...
        room10.addItems(new RangedWeapon("Magnetic Railgun", 150, RangedWeapon.INFINITE_AMMO_CAPACITY, 8000));
        room10.addItems(new RangedWeapon("Atomic Bomb", 35, 1, 15000));
        room10.addItems(new Food("Mars Bar", -30, 40));
        ...
        room11.addItems(new RangedWeapon("Batman's Batarang", 20, 5, 500));
        room11.addItems(new MeleeWeapon("Batman's Batknife", 30, 2500));
        ...
        room12.addItems(new RangedWeapon("Vice City Shotgun", 100, 10, 6000));
        ...
        room13.addItems(new MeleeWeapon("Harley Quinn's Hammer", 100, 4000));
        ...
        room14.addItems(new MeleeWeapon("Sword of Gold", 200, 6000));
        ...
        room15.addItems(new MeleeWeapon("King David's Sword", 300, 7000));
        ...
        room16.addItems(new MeleeWeapon("Pharaoh's Scepter", 80, 4000));
        room16.addItems(new RangedWeapon("Sandstorm Blaster", 150, RangedWeapon.INFINITE_AMMO_CAPACITY, 7000));
        ...
        room17.addItems(new MeleeWeapon("Staff of Moses", 100, 5000));
        room17.addItems(new MeleeWeapon("Sword of Goliath", 150, 6000));
        ...
        room18.addItems(new RangedWeapon("X-Ray Rifle", 40, 50, 7000));
        room18.addItems(new MeleeWeapon("Deceiver Killer Sword", 500, 7000));
        ...
        room19.addItems(new MeleeWeapon("Cold Steel Rapier", 40, 3500));
        ...
        room20.addItems(new MeleeWeapon("Sword of Angels", 300, 6000));
        room20.addItems(new MeleeWeapon("Spear of Destiny", 250, 5000));
        ...
        room21.addItems(new MeleeWeapon("Zombie Killer Sword", 500, 5000));
